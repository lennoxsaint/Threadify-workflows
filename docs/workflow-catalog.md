...
| Create My Week (`create-my-week`) | skill | `threadify-create-my-week` | creator | create my week; plan seven days of Threads content |
...
| Reply First (`reply-first`) | skill | `threadify-reply-first` | advanced | reply first; sort my recent Threads comments; show me which comments need a reply first |
