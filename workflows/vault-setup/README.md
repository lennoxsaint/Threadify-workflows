...
Review 10–20 selected Threads/YouTube sources plus a small shared selection before any import; fewer strong sources may proceed with gaps.
...
is `skills/threadify-vault-setup/SKILL.md` and bundles its references for isolated use.
...
rights checks, fresh evidence and ambiguous-attempt reconciliation.
