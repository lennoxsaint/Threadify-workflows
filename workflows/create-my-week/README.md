...
Plan seven days with rolling drafts by default or all drafts upfront, preserving daily review and continuation.
...
is `skills/threadify-create-my-week/SKILL.md` and bundles its references for isolated use.
