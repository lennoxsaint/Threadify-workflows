...
for (const name of ['creator-system.md', 'creator-engine.md', 'creator-browser-review.md', 'threadify-001.md']) expected.set(`references/${name}`, fs.readFileSync(path.join(root, 'docs', name)));
