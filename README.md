...
The full catalog also includes creator planning, source, offer and approved-delivery workflows. [Reply First](workflows/reply-first/README.md) sorts recent owned-post comments into a private review queue without drafting or sending a reply. [Find Your Niche](workflows/find-your-niche/README.md) can establish a positioning direction, [Refresh Your Threads Profile](workflows/refresh-your-threads-profile/README.md) turns it into three reviewed bio-and-picture systems, and [Choose Your First Offer](workflows/choose-your-first-offer/README.md) compares an intensive, guided lab, and self-serve kit with one fixed scorecard. See the [getting started guide](docs/getting-started.md), [generated workflow catalog](docs/workflow-catalog.md) and [Proof Loops catalog](docs/proof-loops-workflows.md).

In this experimental branch, Post This Next is no longer included in new installations or the active catalog. Its published releases remain unchanged, and the legacy CLI command remains available with a deprecation notice for compatibility. Reply First failed its held-out speed and critical-question recall gates; [read the experiment report](workflows/reply-first/EXPERIMENT.md). This branch is not a proven faster replacement or a new public release.
