...
function validateCampaign(campaign, themes, sensitiveValues) {
...
export function buildMarketPipeline(input) {
  ...
  const sensitiveValues = [...identifiers, ...privateBodies];
  for (const source of input.sources) {
  ...
  validateCampaign(input.campaign, themes, sensitiveValues);
